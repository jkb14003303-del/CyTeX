...
明確な差異が確認された．
そこで本研究では，鉄の発光線のうち，
640\,nm に比べて発光強度が弱い波長 650\,nm の発光画像に着目し，
図\ref{fig:ガス測定範囲}に示す白枠領域内において，
一定以上の発光強度を有するピクセル数を計測した．
同一実験条件下における発光強度分布の一例を図に示す．
本試験では測定条件が4種類存在し，
発光強度の絶対値が測定条件に依存するため，
一律の数値基準による分類は適用できない．
そこで，図に示すように，
発光強度分布中に認められる強度のギャップに着目し，
このギャップを分類境界として，
同一試験条件下において発光状態を
「小」「中」「大」の三段階に分類した．
...
1つ目のケースでは(c)消弧室右上部分の発光強度が弱く，第一ゼロ点で遮断に失敗したケース，
2つ目は(d)消弧室右上部分の発光強度が強く，第一ゼロ点で遮断に成功したケースである．
各ケースのゼロ点直前の電流と電位差結果を図\ref{fig:電流ゼロ点直前の電流と電位差2}に，
