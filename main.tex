...
ゼロ点時間7ms以上の場合において，
第一電流ゼロ点直前における消弧室右上部のガス発光量に明確な差異が確認された．
そこで，鉄の発光線の中で，発光がしづらいである650\,nmの発光画像に着目し，
図\ref{fig:ガス測定範囲}に示す白枠の領域内において，一定以上の発光強度を有するピクセル数を計測し，
ガス発光強度を小中大の三段階に分類した．
表に，ゼロ点時間に基づく遮断時間と，各発光強度の分類表を示す．
その結果，発光強度が高いほど，
再発弧を生じることなく遮断が成立していることが分かる．

\ref{sec:アークスポットとの相関}節と同様に，
ほぼ同じゼロ点時間を有する2つのケースを選定し，各ケースにおけるアーク温度，および導電率を比較した。
1つ目のケースでは(c)消弧室右上部分の発光強度が低く，第一ゼロ点で遮断に失敗したケース，
1つ目のケースでは(c)消弧室右上部分の発光強度が高く，第一ゼロ点で遮断に成功したケース，
2つ目は(d)消弧室右上部分の発光強度が高く，第一ゼロ点で遮断に成功したケースである．
各ケースのゼロ点直前の電流と電位差結果を図12に，波長640 nmにおける発光強度分布に，
同時刻の可動電極位置を模式的に重ねて示したものを図13に，温度・導電率分布を図14に示す．
