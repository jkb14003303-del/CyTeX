...
\subsection{ガス発光との分類}
\ref{sec:遮断時間の分類}において，遮断時間ごとに分類した．
この分類において，「短時間遮断」以外のケースのアークにおいて，
第一電流ゼロ点直前の消弧室右上部分のガス発光量に明確な違いがみられた．
そこで，鉄650nmの発光画像のうち，図に示す部分において一定以上の発光を持つピクセル数の計測を行った．
表にゼロ点時間に基づく遮断時間と発光ピクセル数の分類を示す．
発光強度が高いほど，再発弧せずに遮断されていることが分かる．\\
