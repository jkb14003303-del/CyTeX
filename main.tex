...
一方，誘電的再発弧では，電流ゼロ点から長い時間を経た後，再発弧が生じるため，再発弧時の過渡回復電圧は高い．
...
$16.4\,\mathrm{ms}$ 以上の場合を「長時間遮断」とし，
...
隣接データ間の増分が他の区間と比較して有意に大きい地点を現象の遷移点と見なし，これに基づき「大」「中」「小」の3カテゴリに区分した．
...
第一電流ゼロ点での遮断成功ケースは16回中11回（約70$\%$）であったのに対し，再発弧したケースは16回中2回（約12$\%$）にとどまり，両者の間には明確な差異が確認された．
